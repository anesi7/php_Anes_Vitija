...
// Get featured motorcycles (limit to 6)
$featured_motorcycles = getAllMotorcycles($pdo, null, 6);
...
<head>
    ...
    <title>KTM Motorcycle Shop - Ready to Race</title>
...
<body>
    ...
    <div class="hero-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="display-4 text-white fw-bold">READY TO RACE</h1>
                    <p class="lead text-white">
                        Discover the complete range of KTM motorcycles. From street-dominating DUKEs 
                        to adventure-ready machines, find your perfect ride.
                    </p>
                    <a href="motorcycles.php" class="btn btn-light btn-lg me-3">Shop Now</a>
        ...
        <div class="row">
            <?php foreach($categories as $category): ?>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <a href="motorcycles.php?category=<?php echo urlencode($category['category']); ?>" class="text-decoration-none">
    ...
    <div class="container my-5" id="motorcycles">
        <h2 class="text-center mb-5">Featured Motorcycles</h2>
        <div class="row">
            <?php foreach($featured_motorcycles as $motorcycle): ?>
        ...
        <div class="text-center mt-4">
            <a href="motorcycles.php" class="btn btn-primary btn-lg">View All Motorcycles</a>
        </div>
    </div>
